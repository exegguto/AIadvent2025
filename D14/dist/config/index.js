...
const configSchema = z.object({
    ...
    docker: z.object({
        ...
        memoryLimit: z.coerce.number().default(512),
        cpuLimit: z.coerce.number().default(50),
    }),
    openai: z.object({
    ...
    security: z.object({
        rateLimitWindow: z.coerce.number().default(900000),
        rateLimitMax: z.coerce.number().default(100),
        maxCodeSize: z.coerce.number().default(10000),
    }),
    logging: z.object({
